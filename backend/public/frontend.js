...
/** @constructor */
function $c_Lfrontend_Inbox$() {
}
$c_Lfrontend_Inbox$.prototype = new $h_O();
$c_Lfrontend_Inbox$.prototype.constructor = $c_Lfrontend_Inbox$;
/** @constructor */
function $h_Lfrontend_Inbox$() {
}
$h_Lfrontend_Inbox$.prototype = $c_Lfrontend_Inbox$.prototype;
$c_Lfrontend_Inbox$.prototype.render__V = (function() {
  ...
  var notificationsTitle = document.createElement("h2");
  notificationsTitle.textContent = "Notifications";
  notificationsBox.appendChild(notificationsTitle);
  var elems = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_T.getArrayOf().constr)(["Your appointment for Dental Cleaning is confirmed at 10:00 AM.", "Reminder: Your Checkup is scheduled for 9:15 AM tomorrow.", "Alert: Appointment for Root Canal has been rescheduled to 3:00 PM."]));
  var dummyNotifications = $m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems);
  var this$3 = $n(dummyNotifications);
  var these = this$3;
  while ((!$n(these).isEmpty__Z())) {
    ...
    var x = (("\n         |<p>" + note) + "</p>\n         |<hr>\n         |");
    noteEntry.innerHTML = $m_sc_StringOps$().stripMargin$extension__T__C__T(x, 124);
    notificationsBox.appendChild(noteEntry);
    these = $as_sci_List($n(these).tail__O());
  }
  document.body.appendChild(notificationsBox);
});
var $d_Lfrontend_Inbox$ = new $TypeData().initClass($c_Lfrontend_Inbox$, "frontend.Inbox$", ({
  Lfrontend_Inbox$: 1
}));
var $n_Lfrontend_Inbox$;
function $m_Lfrontend_Inbox$() {
  if ((!$n_Lfrontend_Inbox$)) {
    $n_Lfrontend_Inbox$ = new $c_Lfrontend_Inbox$();
  }
  return $n_Lfrontend_Inbox$;
}
function $s_Lfrontend_Main__main__AT__V(args) {
  var this$1 = $m_Lfrontend_Main$();
  this$1.render__V();
}
/** @constructor */
...
$c_Lfrontend_Main$.prototype.render__V = (function() {
  document.body.innerHTML = "";
  var header = document.createElement("div");
  header.style.backgroundColor = "purple";
  header.style.color = "white";
  ...
  inboxBtn.addEventListener("click", ((_$1) => {
    $m_Lfrontend_Inbox$().render__V();
  }));
  var title = document.createElement("div");
